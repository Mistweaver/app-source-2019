...
import { Dialog, DialogActions, Button, DialogTitle, LinearProgress } from '@material-ui/core';
import Dropzone from '../../../../components/dropzone/Dropzone';
import { uploadSignedAgreement } from '../../../../services/FileServices';
import { validateHTMLResponse } from '../../../../services/HttpResponseChecker';
import { connect } from 'react-redux';
import { loadAgreement } from '../../../actions/AgreementEditorActions';
import { StoreState } from '../../../Store';
import { PurchaseAgreement } from '../../../../objects/purchaseagreement/PurchaseAgreement';

interface AddSignedAgreementModalProps {
	open: boolean;
	onClose: () => void;
	agreementId: string;
	// apiEndPoint?: string;
...
interface SignedAgreementModalState {
	files: any[];
	uploading: boolean;
...
class AddSignedAgreementModal extends React.Component<AddSignedAgreementModalProps, SignedAgreementModalState> {
	constructor(props: AddSignedAgreementModalProps) {
		super(props);
		this.state = {
			files: [],
			uploading: false,
	...
	uploadFiles() {
		...
		this.state.files.forEach((file, index, array) => {
			...
			uploadSignedAgreement(formData).then(res => {
	...
	public render() {
		...
		return(
			<Dialog
				...
				fullWidth={true}
			>
				<DialogTitle id="simple-dialog-title">Add Signed Agreement</DialogTitle>
				<div style={{padding: 15}}>

					{
						...
						<>
							{
								successfullUpload ?
								<p>Signed Document Upload Successful!  Agreement has been executed!</p>
								:
								<>
...
export default connect(mapStateToProps, { loadAgreement })(AddSignedAgreementModal);